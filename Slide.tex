...
\begin{document}
		...
		\begin{minipage}[t]{0.5\textwidth}
			...
			\begin{center}
				\begin{itemize}
					...
					\item I corsi durano su un semestre
	...
	\begin{frame}{Organizzazione lezioni}
		...
		\begin{tabular}{p{0.3\textwidth} p{0.4\textwidth} p{0.4\textwidth}}
			Periodo & Inizio & Fine \\
			& & \\
			Primo semestre & 29/09/2025 & 17/01/2026 \\
			& & \\
	...
	\begin{frame}{Organizzazione sessioni}
		...
		\begin{tabular}{p{0.3\textwidth} p{0.4\textwidth} p{0.4\textwidth}}
			Periodo & Inizio & Fine \\
			& & \\
			Prima sessione & 19/01/2026 & 21/02/2026 \\
			& & \\
			Seconda sessione & 15/06/2026 & 18/07/2026 \\
			& & \\
			Sessione di recupero & 19/08/2026 & 19/09/2026 \\
		\end{tabular}
	\end{frame}
	...
	\begin{frame}{Organizzazione esami: modalità d'esame}
		...
		\begin{itemize}
			...
			\item Scritto + Orale (chiaramente in date diverse)
		\end{itemize}
	...
	\begin{frame}{Calcolo media ponderata}
		La media ponderata si calcola sommando ogni voto moltiplicato per il CFU relativo del corso, dividendo il totale per il numero dei CFU ottenuti.\\
	...
	\begin{frame}{Base di voto di laurea}
		...
		\end{center}
		Rekativo all'esempio precedente:
		\begin{center}
	...
	\begin{frame}{TOLC}
		...
		\begin{itemize}
			\item TOLC-I: ingegneria, informatica, scienze
		...
		In quel sito ti puoi esercitare, capire come funziona, ma sopratutto puoi prenotare il test.
	\end{frame}
	...
	\begin{frame}{TOLC: parte 3}
		...
		Puoi farlo con qualsiasi università, la sua validità resta in tutta Italia.\\
	...
	\begin{frame}{Propedeuticità}
		All'università, per propedeuticità si intende qualcosa (solitamente un corso) che deve essere obbligatoriamente superato per permettere la possibilità di fare un esame di determinati corsi.\\
	...
	\begin{frame}{Moodle}
		Il Moodle dell'università si trova al seguente \href{https://www.unipd.it/elearning}{link} scegliendo quello della propria area dentro la sezione \textbf{Piattaforme Moodle delle scuole6}.\\
